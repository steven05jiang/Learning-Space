...
class QueueService:
    ...
    @staticmethod
    async def enqueue_graph_sync(entity_id: str, operation: str = "update", owner_id: int = None, tags: list = None) -> str:
        ...
        job_id = await enqueue_job("sync_graph", entity_id, operation=operation, owner_id=owner_id, tags=tags)
