...
export const mockNavItems: NavItem[] = [
  ...
  { id: 'knowledge-graph',label: 'Knowledge Graph',href: '/knowledge-graph', icon: 'Network' },
...
export const mockMessages: ChatMessage[] = [
  {
    id: 'msg-001',
    role: 'assistant',
    content: 'Hi! I can help you explore your learning resources. What would you like to know?',
