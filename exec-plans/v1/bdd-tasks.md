...
**Then** a visual graph is rendered with nodes (tags) and edges using React Flow or Cytoscape.js
...
**Given** a logged-in user
**When** they navigate to or open the chat panel
**Then** they see a chat input and any previous conversations
...
**Then** the message is sent to the API, and the assistant's response is displayed
**Tags:** #frontend, #ui, #chat
